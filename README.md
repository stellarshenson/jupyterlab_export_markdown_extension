...
- **Lists and Callouts** - two-space nested lists render as lists, every ordered list restarts at 1, and a bordered `<div>` draws as a box with its accent bar in DOCX and PDF
