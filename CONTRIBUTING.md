...
# Change directory to the jupyterlab_export_markdown_extension directory
...
jupyter server extension enable jupyterlab_export_markdown_extension
...
jupyter server extension disable jupyterlab_export_markdown_extension
...
folder is located. Then you can remove the symlink named `jupyterlab_export_markdown_extension` within that folder.
...
```sh
pytest -vv -r ap --cov jupyterlab_export_markdown_extension
```
